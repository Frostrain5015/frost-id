...
<style>
	...
	.signout-btn { flex: 1; font-family: var(--font-display); font-size: 0.8125rem; font-weight: 400; gap: 0.4rem; cursor: pointer; display: flex; align-items: center; justify-content: center; letter-spacing: 0.08em; text-transform: uppercase; text-decoration: none; color: var(--text-dim); padding: 0.5rem; border: 1px solid transparent; border-radius: var(--radius-sm); transition: color 0.15s, background 0.15s, border-color 0.15s; }
	.signout-btn:hover { color: var(--error); border-color: rgba(217,92,92,0.35); background: rgba(217,92,92,0.05); }
