...
<div class="scene">
	<main class="wrap" class:mounted>
		<div class="card" class:shake={errorShake} class:error-flash={errorShake}>
			...
			<p class="social-hint">{$t('register.social_hint')}</p>
...
<style>
	...
	.social-hint { text-align: center; font-size: 0.6875rem; color: var(--text-dim); opacity: 0.5; margin-top: 0.75rem; }
